...
async function solveExpression(expression){
    ...
    try {
        const response = await fetch(API_URL, {
            ...
            body: JSON.stringify({
                prompt: 'Реши математическое выражение и верни ТОЛЬКО ответ на него. Если выражение нельзя решить, то ответь в формате "Ошибка: локонично описанная причина и возможное решение". Вот выражение:'+expression,
                markdown: false
            })
        });
