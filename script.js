...
async function solveExpression(expression){
    ...
    try {
        const response = await fetch(API_URL, {
            ...
            body: JSON.stringify({
                prompt: 'Реши математическую задачу и дай только ЧИСЛОВОЙ ответ или ответ математической функцией на неё (без "Ответ:" и похожее). Если задачу невозможно решить, то ответь в формате "локонично описанная ошибка и локоничное решение проблемы". Вот выражение:'+expression,
                markdown: false
            })
        });
